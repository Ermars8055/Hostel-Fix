...
const AdminTickets: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      result = result.filter(
        ticket => 
          ...
          ticket.hostelName.toLowerCase().includes(search) ||
          ticket.roomNumber.toLowerCase().includes(search)
      );
    }
    ...
    if (filters.hostel) {
      result = result.filter(ticket => ticket.hostelName === filters.hostel);
    }
