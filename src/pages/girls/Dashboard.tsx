        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mt-8">
          <div className="md:col-span-3 space-y-6">
            <div className="flex justify-between items-center">
              ...
              <Link to="/girls/tickets" className="text-primary-600 hover:text-primary-700 text-sm font-medium">
                View All
              </Link>
            </div>
            ...
            {tickets.length === 0 ? (
              <div className="card text-center py-8">
                ...
                <Link to="/girls/new-ticket" className="btn-primary inline-flex items-center">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="card p-6">
              ...
              <div className="space-y-3">
                ...
                <Link 
                  to="/girls/tickets?status=resolved" 
            ...
            <div className="card p-6">
              ...
              <div className="mt-4 pt-3 border-t border-neutral-100">
                <Link to="/girls/profile" className="text-primary-600 text-sm font-medium hover:text-primary-700 flex items-center">
